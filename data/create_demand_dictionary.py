...
if real_load_data:
    total_count_per_agg = np.array([637, 637, 636])
...
#     #numbers_per_node = np.ones(69) * 30
#     df = pd.read_csv("data/network_composition_dictionaries/nodal_breakdown.csv")
#     customers_per_node = np.array(df["customers"])
...
create_demand_dictionary("test_data_comp",0)